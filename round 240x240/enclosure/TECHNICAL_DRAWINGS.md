...
* **PCB Retention Pocket:** $\varnothing 38.60\text{mm}$ circular top $+ 23.60\text{mm}$ wide bottom tab down to $Y = -26.50\text{mm}$ ($1.80\text{mm}$ deep from rear).
...
### 2. Sheet 2: Main Housing Pod 26mm - Solid Enclosed Shell (`GC9A01-BODY-26`)
...
* **Pass-Through Cable Relief Channel:** $16.00\text{mm} \text{ wide} \times 14.00\text{mm} \text{ tall}$ continuous rear exit slot.
