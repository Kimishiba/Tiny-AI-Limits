...
| **[`gc9a01_main_housing.stl`](file:///Users/alessandrolongoni/Documents/Antigravity/Tiny%20AI%20Limits/round%20240x240/enclosure/gc9a01_main_housing.stl)** | Support-free $27.5\text{mm}$ deep **V2.0 Main Housing** with recessed flat USB-C port ($1.2\text{mm}$ wall), $45^\circ$ self-supporting inner pocket, expanded $19.9\text{mm}$ cradle, inside floor debossed "V2.0", and dual DuPont wire trenches | $54.4 \times 54.4 \times 27.5\text{mm}$ | ~45 mins |
