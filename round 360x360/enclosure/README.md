...
* **Option 2 Rear-Loading Screen Architecture (Direct M2 Tab Clamping):**
  ...
  * **Deepened Tab Relief & DuPont Clearance:** The tab pocket floor is recessed to $Z = 4.20\text{mm}$ with an extra $2.2\text{mm}$ trench over the header ($Y = -34.0\text{mm}$), giving ample room for forward-facing DuPont pins and solders around the rising pillars while leaving $\ge 2.40\text{mm}$ solid front wall thickness.
